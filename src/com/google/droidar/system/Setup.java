...
import com.google.droidar.commands.CommandGroup;
...
import com.google.droidar.gamelogic.FeedbackReports;
...
import com.google.droidar.gl.textures.TextureManager;
import com.google.droidar.gui.GuiSetup;
import com.google.droidar.gui.InfoScreen;
...
public abstract class Setup {
	 ...
	 *            {@link SystemUpdater#addObjectToUpdateCycle(com.google.droidar.worldData.Updateable)}
	 */
			...
			public boolean execute() {
				SimpleUI.showInfoScreen(currentActivity, new EditItem() {
					...
					public void customizeScreen(ModifierGroup group,
							Object message) {
						group.addModifier(new com.google.droidar.gui.simpleUI.modifiers.Headline(
								R.drawable.logo, "DroidAR"));
						group.addModifier(new com.google.droidar.gui.simpleUI.modifiers.InfoText(
